...
#
# 64 bit version (OnePlus 2, OxygenOS)
#
# (C) Lord Boeffla (aka andip71), 04.09.2015
...
MKBOOTIMG_CMDLINE="androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x37 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 boot_cpus=0-3"
...
step5_patch_ramdisk()
{
	...
	{
		# copy dt.img
		cp $BUILD_PATH/$OUTPUT_FOLDER/arch/arm64/boot/dt.img $REPACK_PATH/dt.img
